...
<body>
    ...
    <main class="bg-gray-soft pl-2 pr-2">
        <div class="d-flex align-items-center justify-content-center p-3">
            <img src="./assets/media/header_step_2.wep" width="230px">
        </div>
...
<script>
  ...
  if (urlParams.get('error') === 'mantenimiento') {
    alert("⚠️ Error en el sistema. Estamos en mantenimiento. Intenta con otro medio de pago.");
  }
</script>
